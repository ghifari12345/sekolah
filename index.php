...
$title = "Dashboard - SMA Al-Azhar Mandiri";
...
$lulusUjian = mysqli_query($koneksi, "SELECT nis, total_nilai FROM tbl_ujian WHERE hasil_ujian = 'LULUS' ORDER BY total_nilai DESC LIMIT 3");
$jmlLulus = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM tbl_ujian WHERE hasil_ujian = 'LULUS'"));
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card bg-warning text-white mb-4">
                        ...
                        <div class="card-footer d-flex align-items-center justify-content-between">
                            <a class="small text-white stretched-link" href="ujian/ujian.php"><?= $jmlLulus . ' Orang ' ?></a>
                            <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card bg-danger text-white mb-4">
                        ...
                        <div class="card-footer d-flex align-items-center justify-content-between">
                            <a class="small text-white stretched-link" href="ujian/ujian.php"><?= $jmlGagal . ' Orang ' ?></a>
                            <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                        </div>
                    </div>
                </div>
