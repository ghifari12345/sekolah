...
$title = "Update Siswa - SMA Al-Azhar Gemilang";
    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <ol class="breadcrumb mb-4">
                ...
                <li class="breadcrumb-item">Update Siswa</li>
            </ol>
            <form action="proses-siswa.php" method="POST" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-header">
                        <span class="h5 my2"><i class="fa-solid fa-pen-to-square"></i> Update Siswa</span>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9" style="margin-left: -50px;">
                                        <select name="jurusan" id="jurusan" class="form-select border-0 border-bottom"
                                            required>
                                            <?php
                                            $jurusan = ["Kimia Industri", "Kimia Analis"];
