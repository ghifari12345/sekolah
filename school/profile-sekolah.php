...
$title = "Profile Sekolah - SMA Al-Azhar Gemilang";
...
if ($msg == 'notimage') {
  ...
  <i class="fa-solid fa-triangel-exclamation"></i> Update data sekolah gagal, file yang anda upload bukan gambar..
...
if ($msg == 'oversize') {
    $alert = '<div class="alert alert-warning alert-dismissible fade show" role="alert">
  <i class="fa-solid fa-triangel-exclamation"></i> Update data sekolah gagal, maximal ukuran gambar 1 MB..
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>';
}
            ...
            <form action="proses-sekolah.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-header">
                        <span class="h5 my-2"><i class="fa-solid fa-square-plus"></i> Data Sekolah</span>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-4 text-center px-5">
                                ...
                                <small class="text-secondary">pilih gambar PNG, JPG, atau JPEG dengan ukuran maximal 1
                                    MB</small>
                            </div>
                            <div class="col-8">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9" style="margin-left: -50px;">
                                        <input type="text" class="form-control border-0 border-bottom" id="nama"
                                            name="nama" value="<?= $data['nama'] ?>" placeholder="nama sekolah" required>
                                    </div>
                                </div>
                                <div class="mb-3 row">
