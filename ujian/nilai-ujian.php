...
$title = "Nilai Ujian - SMA Al-Azhar Gemilang";
            ...
            <div class="row">
                <div class="col-7">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item active"><a href="ujian.php">Ujian</a></li>
                        <li class="breadcrumb-item">Nilai Ujian</li>
                    </ol>
                </div>
                <div class="col-5">
                    <div class="card mt-3 border-0">
                        ...
                        <ul class="ps-3">
                            ...
                            <li><small>Nilai rata-rata tiap mata pelajaran tidak boleh dibawah 60</small></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="input-group mb-2">
                                ...
                                <input type="text" name="noUjian" value="<?= $maxno ?>"
                            ...
                            <div class="input-group mb-2">
                                ...
                                <select name="nis" id="nis" class="form-select" required>
                                    ...
                                    while ($data = mysqli_fetch_array($querySiswa)) { ?>
                                        <option value="<?= $data['nis'] ?>"><?= $data['nis'] . '-' . $data['nama'] ?>
                                        </option>
                                        <?php
                                    }
                                    ?>
                    ...
                    <div class="card">
                        <div class="card-body mt-2">
                            <div class="input-group mb-2">
                                ...
                                <input type="text" name="sum" class="form-control" placeholder="Total Nilai"
                                    id="total_nilai" required readonly>
                            </div>
                            <div class="input-group mb-2">
                                <span class="input-group-text col-2 ps-2 fw-bold">Min</i></span>
                                <input type="text" name="min" class="form-control" placeholder="Nilai Terendah"
                                    id="nilai_terendah" required readonly>
                            </div>
                            <div class="input-group mb-2">
                                <span class="input-group-text col-2 ps-2 fw-bold">Max</i></span>
                                <input type="text" name="max" class="form-control" placeholder="Nilai Tertinggi"
                                    id="nilai_tertinggi" required readonly>
                            </div>
                            <div class="input-group mb-2">
                                <span class="input-group-text col-2 ps-2 fw-bold">Avg</i></span>
                                <input type="text" name="avg" class="form-control" placeholder="Nilai Rata-rata"
                                    id="rata2" required readonly>
                            </div>
                        </div>
                    </div>
                </div>
