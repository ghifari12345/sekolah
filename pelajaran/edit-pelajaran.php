...
<di id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">Update Mata Pelajaran</h1>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item active"><a href="pelajaran.php">Back </a></li>
            </ol>
            <div class="row">
                <div class="col-4">
                    <div class="card">
                            ...
                            <form action="proses-pelajaran.php" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="pelajaran" name="pelajaran"
                                        placeholder="nama pelajaran" value="<?= $data['pelajaran'] ?>" required>
                                </div>
                                <div class="mb-3">
                                ...
                                <button type="update" class="btn btn-primary" name="update"><i
                            ...
                            <table class="table table-hover" id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $data['guru'] ?></td>
                                        <td align="center">
                                            <rning type="button" class="btn btn-sm btn-warning rounded-0 col-10">Updating..</button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
