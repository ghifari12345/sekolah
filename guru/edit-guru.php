...
$title = "Siswa - SMA Al-Azhar Gemilang";
    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <ol class="breadcrumb mb-4">
                ...
                <li class="breadcrumb-item active"><a href="guru.php">Guru</a></li>
                <li class="breadcrumb-item">Update Guru</li>
            </ol>
                        ...
                        <div class="row">
                            <div class="col-8">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9" style="margin-left: -50px;">
                                        <input type="tel" name="telpon" pattern="[0-9]{5,}" title="minimal 5 angka"
                                            class="form-control ps-2 border-0 border-bottom" value="<?= $data['telpon'] ?>" required>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                            ...
                            <div class="col-4 text-center px-5">
                                ...
                                <small class="text-secondary">Pilih foto PNG, JPG, JPEG dengan ukuran maximal 1
                                    MB</small>
